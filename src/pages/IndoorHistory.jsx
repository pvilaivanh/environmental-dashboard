  ...
  return (
    <div className="page-content">
      <div className="history-card">
        <h1 className="history-title">Indoor Temperature History</h1>
                          ...
                          <div className="history-day-list">
                            {items.map((item, index) => (
                              <div
                                ...
                                key={`${item.Created}-indoor-${index}`}
                              >
                                <p className="history-day-meta">
                                  {new Date(item.Created).toLocaleTimeString()}
                                </p>
                                <p>
                                  Temp: {Math.round(item.Indoor.TemperatureF)}°F
                                </p>
                                <p>
                                  Humidity: {Math.round(item.Indoor.Humidity)}%
                                </p>
                              </div>
                            ))}
                          </div>
